...
{  
   ...
   forn(i,n){
       ...
       forn(j,m){
           if (s[j].ss.ss != 1 and s[j].ss.ff == 0 and p[i].find(s[j].ff) != p[i].end())
           {
               p[i].erase(p[i].lower_bound(s[j].ff));
               s[j].ss.ss = 1;
           }
       }
       forn(j, m)
       {
           if (s[j].ss.ff == 1 and p[i].find(s[j].ff) != p[i].end())
           {
               p[i].erase(p[i].lower_bound(s[j].ff));
               s[j].ss.ss = 1;
           }
