...
void buildStr(vector<string> &ans,string &str, int pos, int n = 10)
{
    if(pos==10){
        ans.pb(str);
        return;
...
signed main()
{
    ...
    freopen("second_second_meaning_output.txt", "w", stdout);
