...
map<pair<int, int>, int> m; // use to store query
...
void solve()
{
    ...
    */
    while (r - l > 1)
    {
        ...
        int z = query(l, r);
        if (z <= mid)
        { // a2 is present in the first half
            int x = query(l, mid);
            if (x == z)
            { // a1 and a2 present in l...mid -> go left
                r = mid;
            }
            else
            { // a1 and a2 present in different halfs....go right
                l = mid;
            }
        }
        else
        { // a2 is present in 2nd half(mid+1...r)
            int x = query(mid, r);
            if(x == z)
            { // a1 and a2 present in same half...mid to r
                l = mid;
            }
            else
            { // a1 and a2 present in diff half...go l...mid
                r = mid;
            }
        }
    }
