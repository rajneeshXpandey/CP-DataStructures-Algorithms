...
void solve()
{
    ...
    forn(i, n){
        cin>>a>>b;
        string abin = to_bin(a),
               bbin = to_bin(b);
        //deb2(abin,bbin);       
        int l=0,ans=0;
        while (l < 32 and abin[l] == bbin[l])
            ans += (abin[l]-'0')*pow(2, 31 - l), l++;
        cout<<ans<<endl;    
    }
    
}
/*
12 17 => 01100 01101 01110 01111 10000 10001 => 0 ans

2 3 => 10 11 => 10 ans

10 13 => 1010 1011 1100 1101 => 1000 ans

 *******************common prefix of a and b will be the ans************
*/
signed main()
{
