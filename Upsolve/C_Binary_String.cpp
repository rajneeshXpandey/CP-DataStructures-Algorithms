...
inline void printArr(vector<pii> v){for(auto val : v) cout<<val.ff<<','<<val.ss<<' '; cout<<endl;}
...
void solve(){
    string str;
    cin>>str;
    int n=str.size(),score,o=0,z=0;
    forn(i,n){
        if(str[i]=='1') o++;
        else z++;
    }
    /*
    The cost is the maximum of the 
    number of 0s remaining in the string and the number of 1s removed from the string.
    */
    int case1=z,case2=0;
