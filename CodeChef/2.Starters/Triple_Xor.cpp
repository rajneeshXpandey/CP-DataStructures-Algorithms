...
inline ll binexpo(ll a, ll n){ ll res = 1; while (n > 0){ if (n % 2) res *= a; a *= a,n /= 2;} return res;}
...
void solve(){
    ...
    //             // i = b; and c = xxor^i
    //             int b = i,c=(xxor^i);
    //             if(a!=b and b!=c and a!=c and c<maxx) ans++;
    //         }
    //     }
    // } 
    int result = binexpo(4 , n) - 3*(binexpo(2, n)-1) -1;
    cout<<result<<endl;
}
