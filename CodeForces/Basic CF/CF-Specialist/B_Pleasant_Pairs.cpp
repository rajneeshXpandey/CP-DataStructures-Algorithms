...
there are only 2⋅n/x possible values of y. 2⋅n/1+2⋅n/2+2⋅n/3+…2⋅n/n=2⋅n(1/1+1/2+1/3…1/n)=O(nlogn) by the harmonic series. 
Thus the solution runs in O(nlogn) time total.
*/

void solve()
{  
    int n,x,ans=0,prod,sum;
    cin>>n;
    vector<pii> v(n);
    forn(i,n){
        cin>>x;
