...
void solve()
{
    ...
    /*
        start from back
        for ai=0, change ai = ai - #(max_freq_element)
         because it will make them 0
         as if we decrease ai by 1 prexsum of j -> i+1 to n-1 decreases by 1  
    */
    forn(i,n) {
        if(a[i]==0){
            zero[i]=1;
