...
void solve(){
    ...
    if(x1>1 and y1>1 and x1<n and y1<m){
        ans1 = 4;
    }
    if((x1==1 and y1!=1) || (x1!=1 and y1==1) || (x1==n and y1!=m) || (x1!=n and y1==m)){
        ans1 = 3;
    }
    // 4 corners
    if((x1==1 and y1==1) || (x1==1 and y1==m) || (x1==n and y1==1) || (x1==n and y1==m)){
        ans1 = 2;
    }
    // same for x2,y2
    if(x2>1 and y2>1 and x2<n and y2<m){
        ans2 = 4;
    }
    if((x2==1 and y2!=1) || (x2!=1 and y2==1) || (x2==n and y2!=m) || (x2!=n and y2==m)){
        ans2 = 3;
    }
    // 4 corners
    if((x2==1 and y2==1) || (x2==1 and y2==m) || (x2==n and y2==1) || (x2==n and y2==m)){
        ans2 = 2;
    }
