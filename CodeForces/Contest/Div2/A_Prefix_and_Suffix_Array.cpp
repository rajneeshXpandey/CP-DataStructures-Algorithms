...
void solve(){
    ...
    //    st = arr[N-1][0];
    //    s += st;
    //    s += arr[N-2].substr(0, n-1);
    //}
    //else {
    //    st = arr[N-2][0];
    //    s += st;
    //    s += arr[N-1].substr(0, n-1);
    //}
    //deb(s);
    //string s1 = arr[N - 1].substr(0, n - 2), s2 = arr[N - 1].substr(1, n - 2);
    //string s3 = arr[N - 2].substr(0, n - 2), s4 = arr[N - 2].substr(1, n - 2);
    if(arr[N-1].substr(0, n - 2) == arr[N-2].substr(1, n - 2)){
        s += arr[N-2].substr(0, n - 1);
        s += arr[N-1][n-2];
        //deb(s);
