...
void swaps(vector<int> nums, int n, int &ans, string str)
{
    vector<string> all_cyclic_str;
    vector<int> vis(n, 0);
    forn(i, n)
    {
        string cycle_str = "";
        ...
        all_cyclic_str.pb(cycle_str);
    }
    for (auto cycle_str : all_cyclic_str)
    {
        // cout<<cycle_str<<" ";
        ans = lcm(ans, stepToMakeOrg(cycle_str));
    }
