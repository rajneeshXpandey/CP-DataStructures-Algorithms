...
void solve(){
    ...
    forn(i,n){
        if(s[i]=='M' || s[i]=='m') s[i]='m',m=1;
        else if(s[i]=='E' || s[i]=='e') s[i]='e',e=1;
        else if(s[i]=='O'|| s[i]=='o') s[i]='o',o=1;
        else if(s[i]=='W' || s[i]=='w') s[i]='w',w=1;
        else {
            no;
            return;
        }
    ...
    int cnt=0,i=0;
    while(i<n and s[i]=='m') i++,cnt++;
    while(i<n and s[i]=='e') i++,cnt++;
    while(i<n and s[i]=='o') i++,cnt++;
    while(i<n and s[i]=='w') i++,cnt++;
    //deb(cnt);
    if(cnt==n) yes;
    else no;
}
