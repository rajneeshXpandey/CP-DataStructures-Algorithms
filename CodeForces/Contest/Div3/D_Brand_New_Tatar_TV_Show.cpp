...
{
    int l = lower_bound(arr.begin() + idx + 1, arr.end(), arr[idx]) - arr.begin();
    int r = upper_bound(arr.begin() + idx + 1, arr.end(), arr[idx] + k) - arr.begin();
    if(l+1<r && arr[l]==arr[r-1] && r<arr.size() arr[r]){
