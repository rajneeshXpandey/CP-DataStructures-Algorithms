...
void solve()
{
    ...
    if(n==2){
        if((str[0]=='a' and str[1]=='b') or (str[0] == 'b' and str[1] == 'a'))
            no;
        else yes;
        return;
    }
    if ((str[n-1] == 'a' and str[n-2] == 'b') or (str[n-1] == 'b' and str[n-2] == 'a'))
    {
        no;
        return;
    }
    ...
    forn(i, n - 2)
    {
        if ((str[i] == 'a' and str[i + 1] == 'b' and str[i + 2] == 'a' ) or (str[i] == 'b' and str[i + 1] == 'a' and str[i + 2] == 'b'))
        {
            no;
            return;
        }
