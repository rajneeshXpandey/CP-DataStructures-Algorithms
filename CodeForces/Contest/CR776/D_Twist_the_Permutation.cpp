...
// *********************** Code Begins ************************ //
void shiftleft(vector<int> &v, int till, int len)
{
    vector<int> newv = v;
    forn(i, till)
    {
        newv[(i - len + till) % till] = v[i];
    }
    v.swap(newv);
}
void solve()
...
/*
target : 1 2 3 4 5 6 by left shift..
..to get 3 2 5 6 1 4 
