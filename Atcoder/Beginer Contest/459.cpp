...
void solve(){
    ...
    forn(i, n){
        ...
        else if (arr[i][0] == 'd' || arr[i][0] == 'e' || arr[i][0] == 'f')
        {
            ans += "3";
        }
        else if (arr[i][0] == 'g' || arr[i][0] == 'h' || arr[i][0] == 'i')
        {
            ans += "4";
        }
        else if (arr[i][0] == 'j' || arr[i][0] == 'k' || arr[i][0] == 'l')
        {
            ans += "5";
        }
        else if (arr[i][0] == 'm' || arr[i][0] == 'n' || arr[i][0] == 'o')
        {
            ans += "6";
        }
        else if (arr[i][0] == 'p' || arr[i][0] == 'q' || arr[i][0] == 'r' || arr[i][0] == 's')
        {
            ans += "7";
        }
        else if (arr[i][0] == 't' || arr[i][0] == 'u' || arr[i][0] == 'v')
        {
            ans += "8";
        }
        else if (arr[i][0] == 'w' || arr[i][0] == 'x' || arr[i][0] == 'y' || arr[i][0] == 'z')
        {
            ans += "9";
        }
    } 
