...
void solve(){
    ...
    forn(i, n){
        forn(j, m){
            if(arr[i][j] == '.'){
                if(j-1>=0 and j+1<m  and i+1<n){
                    if(arr[i+1][j]=='#' and arr[i+1][j-1]=='#' and arr[i+1][j+1]=='#' and arr[i][j-1]=='#' and arr[i][j+1]=='#'){
                        cout<<i+1<<' '<<j+1<<endl;
                        return;
                    }
                }
        ...
        forn(j, m){
            if(arr[i][j] == '.'){
                if(i-1>=0 and j+1<m and i+1<n){
                    if(arr[i+1][j]=='#' and arr[i-1][j]=='#' and arr[i+1][j+1]=='#' and arr[i][j+1]=='#' and arr[i-1][j+1]=='#'){
                        cout<<i+1<<' '<<j+1<<endl;
                        return;
                    }
                }
        ...
        forn(j, m){
            if(arr[i][j] == '.'){
                if(i-1>=0 and j-1>=0 and i+1<n and j+1<m){
                    if(arr[i+1][j]=='#' and arr[i-1][j]=='#' and arr[i][j+1]=='#' and arr[i][j-1]=='#' and arr[i-1][j-1]=='#' and arr[i+1][j+1]=='#' and arr[i-1][j+1]=='#' and arr[i+1][j-1]=='#'){
                        cout<<i+1<<' '<<j+1<<endl;
                        return;
                    }
                }
