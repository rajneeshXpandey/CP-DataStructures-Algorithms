...
// ********************************* start ********************************** //
const int N = 3e5+10;
int dp[N][2]; // ith state , capslock off/on
void solve(){
    int X,Y,Z;
    cin >> X >> Y >> Z;
    string s;
...
/*
Spend
X milliseconds to press only the 'a' key. If the light on the Caps Lock key is off, a is appended to the string on the screen; if it is on, A is.
Spend
Y milliseconds to press the 'a' key and Shift key simultaneously. If the light on the Caps Lock key is off, A is appended to the string on the screen; if it is on, a is.
Spend
Z milliseconds to press the Caps Lock key. If the light on the Caps Lock key is off, it turns on; if it is on, it turns off.
